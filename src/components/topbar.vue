...
<template>
  ...
  <div class="navbar navbar-expand flex-column flex-md-row navbar-custom">
    <div class="container-fluid">
      ...
      <router-link
        to="/"
        class="navbar-brand mr-0 mr-md-2 logo d-lg-flex align-content-center"
      >
        <span class="logo-lg">
          <img
      ...
      <ul
        class="navbar-nav flex-row ml-auto d-flex list-unstyled topnav-menu float-right mb-0 align-items-center"
      >
        <div>
          <b-dropdown
            class="float-right"
            ...
            <template v-slot:button-content>
              <div class="d-flex">
                ...
                <div
                  ...
                  class="ml-2 d-flex align-items-center justify-content-center bg-primary text-white font-weight-bold"
                >
                  {{ initials }}</div
                >
              </div>
        ...
        <feather
          ...
          type="bell"
          class="icon-dual ml-4"
          @click="$emit('set-width', 0)"
        ></feather>
