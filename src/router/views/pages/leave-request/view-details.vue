...
export default {
    ...
    methods: {
        async getLeaveRequest() {
            try {
                const response = await this.$http.get(`/fetch/${this.$route.params.id}/leave/request`);
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-5">
                            <div class="col-6">
                                <button class="btn btn-primary w-100" @click="approveLeave">Approve</button>
                            </div>
                            <div class="col-6">
                                <button class="btn btn-danger w-100" @click="rejectLeave">Reject</button>
                            </div>
                        </div>
                    </div>
                </div>
